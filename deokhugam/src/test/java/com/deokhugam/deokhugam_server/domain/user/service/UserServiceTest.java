...
class UserServiceTest {
  ...
  void findPowerUsers_Success() {
    ...
    given(powerUserRepository.findPowerUsersDescFirstPage(eq(Period.MONTHLY), any(Limit.class)))
    ...
    verify(powerUserRepository).findPowerUsersDescFirstPage(eq(Period.MONTHLY), any(Limit.class));
