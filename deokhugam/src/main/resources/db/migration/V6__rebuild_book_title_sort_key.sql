CREATE OR REPLACE FUNCTION deokhugam_title_sort_key_v2(input_title TEXT)
RETURNS TEXT AS $$
DECLARE
...
BEGIN
    ...
    FOR index_value IN 1..char_length(numeric_normalized_text) LOOP
        ...
        ELSE
            converted_text := converted_text || current_char;
        END IF;
    END LOOP;
...
UPDATE books
SET title_sort_key = deokhugam_title_sort_key_v2(title);
...
DROP FUNCTION IF EXISTS deokhugam_title_sort_key_v2(TEXT);
